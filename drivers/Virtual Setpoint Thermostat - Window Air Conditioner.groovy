metadata {
    definition(name: "Virtual Setpoint Thermostat - Window Air Conditioner", namespace: "jamesfrank", author: "James Frank") {
        ...
        command "setThermostatMode", [[name:"Thermostat Mode*", type: "ENUM", constraints: ["off", "cool", "eco", "dry"]]]
        command "setThermostatFanMode", [[name:"Fan Mode*", type: "ENUM", constraints: ["low", "medium", "high"]]]
    }
...
def initialize() {
    ...
    sendEvent(name: "supportedThermostatModes", value: ["off", "cool", "eco", "dry"])
    sendEvent(name: "thermostatFanMode", value: "medium")
    sendEvent(name: "supportedThermostatFanModes", value: ["low", "medium", "high"])
}
...
def setThermostatMode(mode) {
    def allowedModes = ["off", "cool", "eco", "dry"]
...
def setThermostatFanMode(mode) {
    def allowedFanModes = ["low", "medium", "high"]
